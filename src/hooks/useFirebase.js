...
const useFirebase = () =>{
    ...
    const signInWithGoogle = (location , history ,redirect_url) =>{
      setIsLoading(true);
    ...
    useEffect(() => {
      fetch(`https://lit-refuge-91293.herokuapp.com/users/${user.email}`)
      .then(res => res.json())
    ...
    const saveUser = (email , displayName ,method) =>{
      ...
      fetch('https://lit-refuge-91293.herokuapp.com/users' , {
        method: method,
        headers : {
